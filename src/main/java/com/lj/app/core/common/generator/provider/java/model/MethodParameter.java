...
import com.lj.app.core.common.generator.util.paranamer.AdaptiveParanamer;
import com.lj.app.core.common.generator.util.paranamer.BytecodeReadingParanamer;
import com.lj.app.core.common.generator.util.paranamer.CachingParanamer;
import com.lj.app.core.common.generator.util.paranamer.DefaultParanamer;
import com.lj.app.core.common.generator.util.paranamer.JavaSourceParanamer;
import com.lj.app.core.common.generator.util.paranamer.Paranamer;
...
public class MethodParameter {
  ...
  public static Paranamer setParanamer(ClassLoader classLoader) {
    paranamer = new CachingParanamer(new AdaptiveParanamer(new DefaultParanamer(), new BytecodeReadingParanamer(),
        new JavaSourceParanamer(classLoader)));
    return paranamer;
  }
  ...
  public static class JavaSourceFileMethodParametersParser {
    public String[] parseJavaFileForParamNames(Method method, String content) {
      Pattern methodPattern = Pattern
          .compile("(?s)" + method.getName() + "\\s*\\(" + getParamsPattern(method) + "\\)\\s*\\{");
