...
/**
 * 
 * copy from springframework Utility class for working with Strings that have placeholder values in them. A placeholder
 * takes the form ${name}. Using PropertyPlaceholderHelper these placeholders can be substituted for user-supplied
 * values.
 * 
...
public class PropertyPlaceholderUtil {
  ...
  /**
   * Creates a new PropertyPlaceholderHelper that uses the supplied prefix and suffix. Unresolvable placeholders are
   * ignored.
   * 
   ...
   *          indicates whether unresolvable placeholders should be ignored (true) or cause an exception (false).
   */
  public PropertyPlaceholderUtil(String placeholderPrefix, String placeholderSuffix, String valueSeparator,
  ...
  /**
   * Replaces all placeholders of format ${name} with the value returned from the supplied {@link PlaceholderResolver}.
   * 
   * @param value
   *          the value containing the placeholders to be replaced.
  ...
  protected String parseStringValue(String strVal, PlaceholderResolver placeholderResolver, Set visitedPlaceholders) {
  ...
  private int findPlaceholderEndIndex(CharSequence buf, int startIndex) {
    ...
    while (index < buf.length()) {
      ...
      } else if (StringUtil.substringMatch(buf, index, this.placeholderPrefix)) {
        withinNestedPlaceholder++;
